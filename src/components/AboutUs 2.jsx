    ...
    <div>
      ...
      >
        ...
        >
          <Box
            sx={{
              marginLeft: { xs: "-30px", sm: "30px", lg: "200px" },
          ...
          >
            <Typography
              sx={{
                padding: { xs: "60px 0 20px 0", md: "100px 0 40px 0" },
          ...
          >
            <Box
              sx={{
                ...
                height: { xs: "300px", sm: "400px", lg: "400px" },
                boxShadow:
        ...
        >
          ...
          >
            <Box
              sx={{
                margin: { sm: "auto", lg: "auto 0px auto 0px" },
        ...
        <Box
          sx={{
            ...
            height: { xs: "1680px", sm: "1100px", lg: "806px" },
            background: "#FFFFFF",
          }}
        >
          <Typography
          ...
          >
            <Box
              sx={{
                ...
                backgroundSize: { xs: "180px", md: "280px" },
                display: "flex", // Added flex display
                justifyContent: "center",
              }}
            >
        ...
        >
          ...
          >
            ...
            >
              <Box
                sx={{
                  ...
                  display: { xs: "block", sm: "flex" },
                  height: { xs: "500px", sm: "400px", md: "250px" },
                  background: "#FFFFFF",
                  boxShadow:
              ...
              >
                ...
                <Box
                  sx={{
                    ...
                    alignItems: "center",
                    justifyContent: "center",
                    marginTop: { xs: "40px", sm: "30px", lg: "50px" },
                    width: { xs: "70%", md: "15.3%" },
                    margin: "auto",
                  }}
                >
            ...
            <Box
              sx={{
                margin: { xs: " 120px auto", sm: "20px auto" },
                width: { xs: "60%", sm: "20%" },
              }}
            >
              <img style={{ width: "100%" }} src={SatisficationLogo} alt="" />
            </Box>
          </Box>
        </Box>
        {/* FOURTH PART  */}
        <Box sx={{ height: "870px", background: "#FFFFFF" }}>
          <Box
            sx={{
              margin: { xs: "100px auto 100px auto", lg: "100px" },
            }}
          >
            <Typography
              variant="h"
            ...
            <Box
              sx={{
                ...
                justifyContent: "center",
                alignItems: "center",
                margin: { xs: "100px auto 100px 20px", lg: "100px 0" },
                height: "100%",
              }}
            >
              <Box
