...
const Homepage =()=>{
    ...
    return(
        <Stack sx={{marginTop:{xs:"0px",md:"-100px"},position:"relative",top:"0",width:"100vw",overflowX:"hidden"}}>
            <Box className="hero">
            {/* instead of height put marginTop to solve the click issue in Ecard */}
                <svg width="100vw" viewBox="0 0 1920 447" fill="none" xmlns="http://www.w3.org/2000/svg" style={{position:"absolute",top:isSmallScreen?"45vw":"32vw"}}> 
            ...
            <Box sx={{width:"100vw",backgroundColor:"common.white",paddingTop:{xs:"45vw",sm:"20vw",md:"15vw",lg:"5vh",xl:"0vw"}}}>
            <Ecard />
            <CSlider />
            <Attractions />
            <Aboutus />
