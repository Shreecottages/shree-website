    ...
    <Stack>
      ...
      <Box sx={{ padding: { xs: "10vw 5vw", md: "5vw 10vw" } }}>
        ...
        <Box sx={{ marginTop: "3vw" }}>
          <Typography variant="h2" sx={{ color: "#3d2521", alignSelf: "left", textAlign: "left", m: { xs: " 2vw 0vw", sm: "1.5vw 0vw" } }}>Blog1</Typography>
          ...
          <Typography variant="body1" className={classes.blogContent} sx={{ alignSelf: "left", textAlign: "left", m: { xs: " 4vw 0vw", sm: "2vw 0vw" }, lineHeight: "2" }}>
            ...
            sollicitudin justo eget fringilla congue. Sed sagittis eget
            tortor nec dapibus. Duis quis magna eu dui pellentesque interdum
            at in erat. Duis vitae ex ultricies, dapibus purus vitae, congue
            odio. Nullam at odio in nibh tempus varius. Cras convallis
            hendrerit bibendum. Nulla ut velit in arcu tincidunt ultrices ac
            eu nulla. Nulla facilisi. Phasellus consectetur enim eu ipsum
            blandit, non luctus metus ultrices.
          </Typography>
        </Box>

        {/* Sub Heading 1 */}
        <Box sx={{ mt: 4 }}>
          <Typography variant="h4" sx={{ color: "#3D2521", alignSelf: "left", textAlign: "left", m: { xs: " 1.5vw 0vw", sm: "1vw 0vw" } }}>Sub Heading 1</Typography>
          <Divider sx={{ backgroundColor: "#FFBB70" }} />
          <Typography variant="body1" className={classes.blogContent} sx={{ alignSelf: "left", textAlign: "left", m: { xs: " 1vw 0vw", sm: "1vw 0vw" }, lineHeight: "2" }}>
            ...
            condimentum, justo lectus facilisis tortor, nec volutpat augue
            dolor vel mauris. Cras id elementum dui. Proin et magna nec tellus
            dictum consequat. Vivamus tristique nec est vel venenatis.
          </Typography>
        </Box>

        {/* Sub Heading 2 */}
        <Box sx={{ mt: 4 }}>
          <Typography variant="h4" sx={{ color: "#3D2521", alignSelf: "left", textAlign: "left", m: { xs: " 1.5vw 0vw", sm: "1vw 0vw" } }}>Sub Heading 2</Typography>
          <Divider sx={{ backgroundColor: "#FFBB70" }} />
          <Typography variant="body1" className={classes.blogContent} sx={{ alignSelf: "left", textAlign: "left", m: { xs: " 1vw 0vw", sm: "1vw 0vw" }, lineHeight: "2" }}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
            sollicitudin justo eget fringilla congue. Sed sagittis eget
        ...
        {/* Sub Heading 3 */}
        <Box sx={{ mt: 4 }}>
          <Typography variant="h4" sx={{ color: "#3D2521", alignSelf: "left", textAlign: "left", m: { xs: " 1.5vw 0vw", sm: "1vw 0vw" } }}>Sub Heading 3</Typography>
          <Divider sx={{ backgroundColor: "#FFBB70" }} />
          <Typography variant="body1" className={classes.blogContent} sx={{ alignSelf: "left", textAlign: "left", m: { xs: " 1vw 0vw", sm: "1vw 0vw" }, lineHeight: "2" }}>
