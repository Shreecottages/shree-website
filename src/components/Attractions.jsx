...
export default function Attractions(){
    ...
    return(
        <Box display="flex" flexDirection="column" justifyContent="center" textAlign="center" sx={{padding:{xs:"10vw 5vw",md:"5vw 10vw"},maxWidth:"100vw",overflowX:"clip"}}>
                ...
                <Box display='flex' flexDirection="column">
                    <Box display="flex" justifyContent={"space-between"} sx={{ flexDirection: { xs: "column", md: "row"}, mb:'4vw' }}>
                        ...
                        <Box flexDirection="column" textAlign="left" sx={{
                            ...
                            <Typography variant="body1" sx={{textAlign: {xs:"left", md:"justify"},'@media(max-width:1150px) and (min-width:900px)':{fontSize:"0.9rem"}}}>
                                Embark on a thrilling 3-hour ride through the magnificent Gir National Park
                                aboard an open Jeep. Witness the awe-inspiring wildlife in their natural habitat, as this safari
                                offers an incredible opportunity to observe and connect with the mesmerizing fauna of the
                                Gir Jungle.
                            </Typography>
                    ...
                    <Box display="flex" justifyContent={"space-between"} sx={{ flexDirection: { xs: "column", md: "row-reverse"} }}>
                        ...
                        <Box display="flex" flexDirection="column" textAlign="left" sx={{
                            ...
                            <Typography variant="body1" sx={{ textAlign: {xs:"left", md:"justify"},'@media(max-width:1150px) and (min-width:900px)':{fontSize:"0.9rem"}}}>
                                Diu Island, connected by a bridge to Gujarat's southern coast, resonates with
                                Portuguese heritage. Its notable architectural gems encompass three churches and a
                                seafront fort. Beyond the bustling tourist-filled waterfront, the town streets offer a serene
                                and immaculate atmosphere. Notably, alcohol is permissible on this charming island.
                            </Typography>
