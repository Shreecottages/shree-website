...
import RoomT11 from "../images/Rooms_Images/RoomT1/T1(1).jpg";
import RoomT12 from "../images/Rooms_Images/RoomT1/T1(2).jpg";
...
const roomImages = {
  RoomT1: [RoomT11, RoomT12 /* ... */],
  RoomT2: [
    /* ... */
  ],
  // ... add images for other rooms
};
  ...
  return (
    <Stack>
      <Helmet>
        ...
        <meta
          name="description"
          content="Resorts price range starts from Rs.1500 to 3000 per night in Sasan Gir. ✓Free WiFi ✓AC Rooms With Garden View ✓Swimming Pool ✓Free Cancellation."
        />
        <meta
          name="keywords"
          content="shree Cottage, shree Party Plot, resort, hotel ,rooms , hotel rooms,sasan gir ,talala gir ,gir ,gujarat"
        />
        ...
        <meta
          name="og:title"
          content="Sasan Gir Resort Booking At Best Price - Shree Cottages"
        />
      ...
      >
        ...
        >
          ...
          <Box sx={{ display: "flex", m: { xs: " 0vw -10vw", sm: "0vw" } }}>
            <Button
              variant="text"
              className={`room ${activeStep === 0 && "active"}`}
              sx={{
                color: "warning.main",
                textTransform: "none",
                padding: "0",
                mr: { xs: "2.5vw", sm: "2vw", lg: "4vw" },
              }}
              onClick={() => {
                setActiveStep(0);
                setActiveImg(0);
            ...
            <Button
              variant="text"
              className={`room ${activeStep === 1 && "active"}`}
              sx={{
                color: "warning.main",
                textTransform: "none",
                padding: "0",
            ...
            <Button
              variant="text"
              className={`room ${activeStep === 2 && "active"}`}
              sx={{
                color: "warning.main",
                textTransform: "none",
                padding: "0",
        ...
        >
            ...
            >
              <Box
                ...
                sx={{
                  position: "relative",
                  width: "100%",
                  borderRadius: { xs: "10px 10px 0px 0px", md: "0px" },
                  overflow: "hidden",
                }}
              >
                <img
                  style={{ width: "100%" }}
                  // src={require(
                  //   `../images/Rooms_Images/${steps[activeStep].image[activeImg]}`
                  // )}
                  src={roomImages[steps[activeStep].label][activeImg]}
                  alt="Description of the img or an empty string for decorative imgs"
                />
              </Box>
              <Box
                sx={{
              ...
              >
                <IconButton
                  ...
                  onClick={isSmallScreen ? null : handleBack}
                ...
                <IconButton
                  ...
                  onClick={isSmallScreen ? null : handleNext}
                  disabled={activeImg === maxImg - 1}
                  sx={{
                    backgroundColor: "common.black",
                    border: "1px solid",
                    borderColor: "common.black",
          ...
          <Box sx={{ padding: "3vw 2.5vw" }}>
            ...
            >
              ...
              {/* -----------------Amenities content--------------------------------------------------------------------------- */}
              <Typography variant="h2" sx={{ mt: { xs: "5vw", md: "0vw" } }}>
                Amenities
              </Typography>
            </Box>
            <Box sx={{ padding: "2vw 0vw" }}>
              <List sx={{ listStyle: "none", pl: 2 }} disablePadding>
                {steps[activeStep].amenities.map((amenity) => (
                  <Grid xs={2} sm={4} key={uuidv4()}>
              ...
              {/* <List sx={{ listStyle: "none", pl: 2 }} disablePadding>
                {steps[activeStep].amenities.map((amenity, index) => (
                  <Grid xs={2} sm={4} key={index + amenity}>
                    <ListItem sx={{ display: "list-item" }} disablePadding>
                      • {amenity}
                    </ListItem>
                  </Grid>
                ...
                <Grid container columns={{ xs: 2, md: 8, lg: 12 }}>
                  {steps[activeStep].amenities.map((_, index) => (
                    <Grid xs={2} sm={4} key={index}>
                      <ListItem sx={{ display: "list-item" }} disablePadding>
                        • {steps[activeStep].amenities[index]}
                      </ListItem>
                    </Grid>
                  ))}
                </Grid>
            ...
            <Button
              variant="contained"
              sx={{ m: { xs: "2vw 0vw 4vw 1vw", md: "0vw" } }}
              onClick={() =>
                window.open(
