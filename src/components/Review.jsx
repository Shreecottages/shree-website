...
import c1Img from "../images/Prof/C1.png";
import c2Img from "../images/Prof/C2.png";

const Review = () => {
  const imageMap = {
    "C1.png": c1Img,
    "C2.png": c2Img,
    // Add other image paths similarly for all cards
  };
  ...
  return (
    <Box
      ...
      textAlign="center"
      sx={{
        padding: { xs: "10vw 5vw", md: "5vw 0vw" },
        backgroundColor: "common.white",
      }}
    >
      <Typography variant="h2" sx={{ p: "0vw 10vw" }}>
      ...
      <Box display="flex" flexDirection="column" sx={{ alignItems: "center" }}>
        ...
        >
          ...
          <Slider {...settings}>
            {Creview.map((card) => {
              const imageSource = imageMap[card.prof.img];
              return (
                <Card
                  key={card.id} // Assuming card has a unique id property
                  className="card"
                  raised={0}
                  sx={{
                ...
                > */}
                  ...
                  <CardHeader
                    avatar={
                      <Avatar
                        src={imageSource.default} // Use imageSource.default to access the image path
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://search.google.com/local/writereview?placeid=ChIJ0fEovSfK4jsRxrcm9yXgCeY&source=g.page.m.rc._&laa=merchant-web-dashboard-card",
